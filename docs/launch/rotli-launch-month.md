...
| Tue 6 | IG carousel: `how-rotli-works` (4; the same 4 images post on X). X: `rotli-card/x-post` | IG: "How Rotli works, in four slides. Free, no account, works offline." | The carousel is the saveable explainer; saves drive IG reach in week 1. |
