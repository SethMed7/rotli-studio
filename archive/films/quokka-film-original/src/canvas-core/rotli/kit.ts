...
export const C = {
  linen: "#f8f2e9", surface: "#ffffff", surface2: "#f1e7d8", peach: "#f2d6c2", border: "#e7dbc9",
  cocoa: "#3a3028", ink: "#2b231d", muted: "#6e6155", clay: "#c97e62", clayText: "#8f4e37",
  olive: "#8d9a76", oliveText: "#5f6b49", oliveBright: "#a9b78f", blue: "#2f6f9e",
  night: "#241d18", nightSurface: "#2e2620", nightSurface2: "#392f28", nightText: "#f1e7da", nightMuted: "#b7a593", nightBorder: "#4a3d33",
  // Rottnest: turquoise bay, limestone, salt-lake pink, bush green
  sea: "#7fcfc6", seaDeep: "#3fa3a6", seaLine: "#e9fbf6", sand: "#f1e3c4", limestone: "#e6d3ad", lake: "#f0a7a0", bush: "#8d9a76", bushDark: "#6d7a58", sky: "#fbf3e6",
  badge: "#d8503f",
};
export const FONT = { ui: "'General Sans', sans-serif", word: "'Baloo 2', sans-serif", mono: "Menlo, 'SF Mono', monospace" };
...
export const measure = (ctx: Ctx, s: string, size: number, weight: number | string = 500, font = FONT.ui) => { ctx.save(); ctx.font = `${weight} ${size}px ${font}`; const w = ctx.measureText(s).width; ctx.restore(); return w; };

// ---------------------------------------------------------------- grounds
/** linen paper with soft diagonal bands that drift, so no frame is ever a still */
export const paperGround = (ctx: Ctx, frame: number, band = C.peach, alpha = 0.32) => {
...
export const nightGround = (ctx: Ctx, frame: number, seed = 7) => {
