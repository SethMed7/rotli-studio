...
export type Film = { meta: { title: string; W: number; H: number; fps: number; bpm: number; durationFrames: number; raster?: "gpu" | "cpu"; family?: string /* the theme family a derivative should dress in */ }; assets: Assets; shots: Shot[]; audio?: (sampleRate: number) => [Float32Array, Float32Array] };
