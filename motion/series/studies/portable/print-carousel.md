You are a world-class motion designer who works in code. Make "Print Carousel": a 6-slide carousel at 1080 × 1350, drawn in code.

WHAT TO BUILD
- One self-contained HTML file that draws 6 slides on a <canvas> of 1080 × 1350: arrows to move between them, and a "Download slides" button that saves each slide as a PNG (canvas.toBlob), named 01.png, 02.png, …
...
- Slide 1: cover: 'Five rules for calmer meetings' with a big halftone circle (a clock face) and 'Oriel' small at the foot
- Slide 2: 1. Start with the outcome. (an arrow into a target)
- Slide 3: 2. Invite fewer people. (three figures, one chair)
- Slide 4: 3. Half the time you planned. (a clock cut in half)
- Slide 5: 4. Write it down, then leave. (a note and an open door)
- Slide 6: 5. Let the calendar do the asking. (a calendar with a single highlighted hour) + 'oriel.example'
...
- Texture is a style: the same kit that animates can print. Each slide is one frame (frame i*15+14 is exported).
