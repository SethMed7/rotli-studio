...
lives in its own theme family and atmosphere. The bible is `motion/season/bible.md`, the briefs are
`motion/season/episodes/`, and how each one is made (or re-made) is `motion/workflows/README.md`.
